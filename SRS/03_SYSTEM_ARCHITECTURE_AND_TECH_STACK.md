...
> Also carries a **legacy, unused** `finalGrade`, `gradeBreakdown`, `gradeStatus`, `gradeSubmittedAt`, `gradeSubmittedBy` set that `server.js:74-91` still migrates on startup, though no controller writes it.
